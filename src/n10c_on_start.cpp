...
void N10C::OnStart()
{
	...
	Events().Register(
		...
		[this](const guitar::EventBase *pEvent) -> bool
		{
			const auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			if (m_SelectedJoystick < 0)
			{
				event.Payload = "Keyboard";
				return true;
			}

			auto joysticks = Input().ListJoysticks();
			event.Payload = joysticks[m_SelectedJoystick];
			return true;
		});
	Events().Register(
	...
	Events().Register(
		"get_twist_linear_x", this,
		[this](const guitar::EventBase *pEvent) -> bool
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_TwistMessage.linear.x);
			return true;
		});
	Events().Register(
		"get_twist_linear_y", this,
		[this](const guitar::EventBase *pEvent) -> bool
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_TwistMessage.linear.y);
			return true;
		});
	Events().Register(
		"get_twist_angular_z", this,
		[this](const guitar::EventBase *pEvent) -> bool
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_TwistMessage.angular.z);
			return true;
		});
	Events().Register(
		"get_gripper_0", this,
		...
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_GripperMessage.data[0]);
			return true;
		});
	Events().Register(
		"get_gripper_1", this,
		...
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_GripperMessage.data[1]);
			return true;
		});
	Events().Register(
		"get_gripper_2", this,
		...
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_GripperMessage.data[2]);
			return true;
		});
	Events().Register(
		"get_gripper_3", this,
		...
		{
			auto &event = *(guitar::MutableEvent<std::string> *) pEvent;
			event.Payload = std::to_string(m_GripperMessage.data[3]);
			return true;
		});
	...
	m_GripperMessage.data[2] = 0;
	m_GripperMessage.data[3] = -1;
}
